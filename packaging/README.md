...
```bash
VERSION=0.9.0 TARGET=x86_64-unknown-linux-gnu scripts/build-release.sh
VERSION=0.9.0 TARGET=x86_64-unknown-linux-gnu scripts/package-release.sh
VERSION=0.9.0 TARGET=x86_64-unknown-linux-gnu scripts/smoke-release.sh

VERSION=0.9.0 TARGET=aarch64-unknown-linux-gnu scripts/build-release.sh
VERSION=0.9.0 TARGET=aarch64-unknown-linux-gnu scripts/package-release.sh
VERSION=0.9.0 TARGET=aarch64-unknown-linux-gnu scripts/smoke-release.sh
```
...
VERSION=0.9.0 TARGET=x86_64-unknown-linux-musl scripts/smoke-release.sh
...
VERSION=0.9.0 TARGET=aarch64-unknown-linux-musl scripts/smoke-release.sh
```
...
```bash
VERSION=0.9.0 TARGET=x86_64-apple-darwin scripts/build-release.sh
VERSION=0.9.0 TARGET=x86_64-apple-darwin scripts/package-release.sh
VERSION=0.9.0 TARGET=x86_64-apple-darwin scripts/smoke-release.sh
```
