...
pub(super) use super::super::{
    ...
    RuntimeSemanticEmbeddingExecutor, SEMANTIC_CHUNK_MAX_CHARS, SemanticRuntimeEmbeddingExecutor,
    SourceSpan, SymbolDefinition, SymbolKind, SymbolLanguage, build_file_semantic_chunks,
