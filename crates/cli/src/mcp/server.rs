...
use crate::mcp::types::{
    ...
    WorkspaceDetachResponse, WorkspaceDirtyScope, WorkspaceFreshnessSummary, WorkspaceIndexAction,
    ...
    WorkspaceIndexResponse, WorkspaceParams, WorkspacePostEditStrategy,
