...
use crate::searcher::lexical_channel::HybridPathWitnessQueryContext;
use crate::storage::{
...
use super::{
    GenericWitnessSurfaceFamily, HybridRankingIntent, StoredPathWitnessProjection,
    ...
    hybrid_source_class, is_ci_workflow_path, is_entrypoint_build_workflow_path,
    is_entrypoint_runtime_path, is_runtime_config_artifact_path, is_scripts_ops_path,
...
pub(in crate::searcher) struct PathOverlayBoost {
    pub(in crate::searcher) bonus_millis: u32,
    pub(in crate::searcher) provenance_ids: Vec<String>,
}

impl PathOverlayBoost {
    pub(in crate::searcher) fn merge(&mut self, other: Self) {
    ...
    pub(in crate::searcher) fn bonus_score(&self) -> f32 {
        self.bonus_millis as f32 / 1000.0
    }
}

#[derive(Debug, Clone, Serialize, Deserialize, PartialEq, Eq, Default)]
pub(in crate::searcher) struct TestSubjectProjectionFlags {
    pub(in crate::searcher) exact_stem_match: bool,
    pub(in crate::searcher) same_language: bool,
    pub(in crate::searcher) runtime_subject: bool,
    pub(in crate::searcher) support_subject: bool,
}

#[derive(Debug, Clone, PartialEq, Eq)]
pub(crate) struct StoredTestSubjectProjection {
    pub(in crate::searcher) test_path: String,
    pub(in crate::searcher) subject_path: String,
    pub(in crate::searcher) shared_terms: Vec<String>,
    pub(in crate::searcher) score_hint: usize,
    pub(in crate::searcher) flags: TestSubjectProjectionFlags,
}

#[derive(Debug, Clone, Serialize, Deserialize, PartialEq, Eq, Default)]
pub(in crate::searcher) struct EntrypointSurfaceProjectionFlags {
    pub(in crate::searcher) is_runtime_entrypoint: bool,
    pub(in crate::searcher) is_build_workflow: bool,
    pub(in crate::searcher) is_runtime_config_artifact: bool,
    pub(in crate::searcher) is_ci_workflow: bool,
    pub(in crate::searcher) is_scripts_ops: bool,
}

#[derive(Debug, Clone, PartialEq, Eq)]
pub(crate) struct StoredEntrypointSurfaceProjection {
    pub(in crate::searcher) path: String,
    pub(in crate::searcher) path_class: PathClass,
    pub(in crate::searcher) source_class: SourceClass,
    pub(in crate::searcher) path_terms: Vec<String>,
    pub(in crate::searcher) surface_terms: Vec<String>,
    pub(in crate::searcher) flags: EntrypointSurfaceProjectionFlags,
}
...
pub(in crate::searcher) fn decode_test_subject_projection_record(
...
pub(in crate::searcher) fn build_entrypoint_surface_projection_record(
    path: &str,
...
pub(in crate::searcher) fn entrypoint_surface_overlay_boost(
...
pub(in crate::searcher) fn accumulate_test_subject_overlay_boosts(
...
pub(in crate::searcher) fn accumulate_companion_surface_overlay_boosts(
...
pub(in crate::searcher) fn accumulate_relation_overlay_boosts(
...
impl StoredEntrypointSurfaceProjection {
    pub(in crate::searcher) fn from_path(path: &str) -> Option<Self> {
