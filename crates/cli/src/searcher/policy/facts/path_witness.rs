...
pub(crate) struct PathWitnessFacts {
    ...
    pub(crate) is_package_surface: bool,
    pub(crate) is_build_config_surface: bool,
    pub(crate) is_workspace_config_surface: bool,
...
impl PathWitnessFacts {
    pub(crate) fn from_projection(
        ...
        Self {
            ...
            is_package_surface: projection.flags.is_package_surface,
            is_build_config_surface: projection.flags.is_build_config_surface,
            is_workspace_config_surface: projection.flags.is_workspace_config_surface,
...
impl Default for PathWitnessFacts {
    fn default() -> Self {
        Self {
            ...
            is_package_surface: false,
            is_build_config_surface: false,
            is_workspace_config_surface: false,
