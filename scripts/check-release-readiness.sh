...
errors_contract="docs/contracts/errors.md"
tools_contract_readme="docs/contracts/tools/v1/README.md"
contract_changelog="docs/contracts/changelog.md"
bench_readme="docs/benchmarks/README.md"
bench_report="docs/benchmarks/latest-report.md"
bench_budget="docs/benchmarks/budgets.v1.json"
bench_generator="docs/benchmarks/generate_latency_report.py"
bench_search="docs/benchmarks/search.md"
bench_mcp="docs/benchmarks/mcp-tools.md"
...
if ! cmp -s "$fresh_signature" "$committed_signature"; then
  fail "benchmark latest report workload/budget signature drifted; refresh docs/benchmarks/latest-report.md from current budgets/workloads"
fi
...
echo "- python3 docs/benchmarks/generate_latency_report.py --fail-on-budget --output <tmp>"
