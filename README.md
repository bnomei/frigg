...
```bash
curl -fsSL https://raw.githubusercontent.com/bnomei/frigg/main/scripts/install.sh | FRIGG_VERSION=0.9.1 sh
```
...
| Docker image | `docker run --rm ghcr.io/bnomei/frigg:0.9.1 --version` |
